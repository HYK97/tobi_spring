...
public class PointCutTest {
    ...
    public void pointcut() throws Exception {
        ...
        tagetClassPointcutMatches("execution(* RealConnection.learningtest.Target.*(..))", true, true, true, true, true, false);
        tagetClassPointcutMatches("execution(* RealConnection.learningtest.*.*(..))", true, true, true, true, true, true);
        tagetClassPointcutMatches("execution(* RealConnection.learningtest..*.*(..))", true, true, true, true, true, true);
        tagetClassPointcutMatches("execution(* RealConnection..*.*(..))", true, true, true, true, true, true);
